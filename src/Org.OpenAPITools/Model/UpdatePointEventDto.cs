...
namespace Org.OpenAPITools.Model
{
    ...
    /// UpdatePointEventDto
    /// </summary>
    [DataContract(Name = "UpdatePointEventDto")]
    public partial class UpdatePointEventDto : IEquatable<UpdatePointEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePointEventDto" /> class.
        /// </summary>
        /// <param name="hashString">The hash string is used to make sure each event will only result in points awarded once. It should be unique for each event and user, in such a way the same hashString will predictably get generated if the same event was sent again. For example, it could be the string \&quot;created-pledge-page\&quot; followed by the user&#39;s id in another system..</param>
        ...
        /// <param name="verb">The verb to display along with the point event in user interfaces. For example: \&quot;You connected Facebook\&quot;.</param>
        /// <param name="platform">Social platform (twitter, instagram, facebook) or other external platform where the event was awarded from.</param>
        /// <param name="message">Message to display to the user..</param>
        /// <param name="isBurn">For awarding points, set this to false. Set to true if you want to consume points instead of awarding them.</param>
        /// <param name="points">Number of points to award for this event..</param>
        /// <param name="timestamp">For displaying to the user, the related time when the points were awarded..</param>
        /// <param name="metadata">Any custom metadata.</param>
        public UpdatePointEventDto(string hashString = default(string), string userid = default(string), string email = default(string), string icon = default(string), string verb = default(string), string platform = default(string), string message = default(string), bool isBurn = default(bool), decimal points = default(decimal), DateTime timestamp = default(DateTime), Object metadata = default(Object))
        {
        ...
        [DataMember(Name = "hashString", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "isBurn", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePointEventDto {\n");
        ...
        {
            return this.Equals(input as UpdatePointEventDto);
        }

        /// <summary>
        /// Returns true if UpdatePointEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePointEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePointEventDto input)
        {
            if (input == null)
            {
                return false;
